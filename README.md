...
Public pull requests run the complete check suite on GitHub-hosted Ubuntu with
a five-minute budget. The workflow grants read-only repository contents and
